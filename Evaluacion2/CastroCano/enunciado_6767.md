...
> ⚙️ **Enunciado personalizado — ID 6767.** Los parámetros son únicos. 
...
2. Carpeta con los **apellidos** en la raíz del repositorio:
   ...
   ├── enunciado_6767.md   # el enunciado personalizado
   └── datos_6767.npz      # los datos
   ```
...
(**Comentario**: ¿Cuál es la razón para divir el dataset si no hay predicciones?.)

### Comparación de inicializaciones (25 pts)
- [0] **Gráfica:** curvas de la pérdida $\mathcal{L}$ vs iteraciones, con las dos inicializaciones superpuestas en la misma figura.
...
(**Comentario**: Las graficas son mejores en loglog. Hay algo muy raro en el entrenamiento tienes números demasiado grandes. No se encuentran las iteraciones pedidas.)
...
(**Comentario**: La idea es usar la matriz que construimos)