...
> ⚙️ **Enunciado personalizado — ID 3714.** Los parámetros son únicos. 
...
2. Carpeta con los **apellidos** en la raíz del repositorio:
   ...
   ├── enunciado_3714.md   # el enunciado personalizado
   └── datos_3714.npz      # los datos
   ```
...
(**Comentario**: ¿Para qué se añade una partición train/val (no pedida)? Es muy raro que el error en train sea 0 y en validación ~80%)
...
(**Comentario**: Usa semilogy, no loglog. La medición de iteraciones hasta error<0.1 usa el error relativo bien pero no queda claro en que conjunto) 
