...
> ⚙️ **Enunciado personalizado — ID 6111.** Los parámetros son únicos. 
...
2. Carpeta con los **apellidos** en la raíz del repositorio:
   ...
   ├── enunciado_6111.md   # el enunciado personalizado
   └── datos_6111.npz      # los datos
   ```
...
- [9] Red entrenada con las dos inicializaciones (Fourier y aleatoria), con los parámetros del enunciado.
- [8] Error de reconstrucción relativo ||x̂-x||/||x|| reportado para cada caso.

(**Comentario**: La gráfica de reconstrucción por régimen solo muestra la curva con inicialización Fourier)
...
(**Comentario**: Curva de pérdida (semilogy). Falta encontrar el número de iteraciones para alcanzar el error de 0.1)
