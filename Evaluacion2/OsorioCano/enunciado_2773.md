...
> ⚙️ **Enunciado personalizado — ID 2773.** Los parámetros son únicos. 
...
2. Carpeta con los **apellidos** en la raíz del repositorio:
   ...
   ├── enunciado_2773.md   # el enunciado personalizado
   └── datos_2773.npz      # los datos
   ```
...
(**Comentario**: Entrena una red por régimen en vez de una única red por inicialización.
...
(**Comentario**: La medición de iteraciones hasta err_rel<0.1 usa el error relativo real por señal. Si antes usabas 3 redes diferentes entonces cuál no llega al umbral y porqué el regimen 1 si antes el error a 3000 iteraciones era menos de 0.1? 

### Compresión (10 pts)
- [4] **Gráfica:** error de reconstrucción vs número de coeficientes conservados.
- [3] Cuántos coeficientes bastan para lograr el umbral de energía del enunciado.

(**Comentario**: Se truncan los coeficientes en orden de frecuencia (los primeros k modos) en vez de ordenarlos por energía descendente.
