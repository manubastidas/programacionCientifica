...
> ⚙️ **Enunciado personalizado — ID 5385.** Los parámetros son únicos. 
...
2. Carpeta con los **apellidos** en la raíz del repositorio:
   ...
   ├── enunciado_5385.md   # el enunciado personalizado
   └── datos_5385.npz      # los datos
   ```
...
(**Comentario**: La solución original tenía un bug (`forward_jax` indefinido))
...
- [9] Medición de cuántas iteraciones necesita cada inicialización para que el error relativo < 0.1.
- [5] **Gráfica/análisis del régimen indicado:** contrastar velocidad de convergencia para el régimen que indica el enunciado.

(**Comentario**: La curva de pérdida usa solo escala log en y)
...
(**Comentario**: ¿Cómo sigue despupes de la capacidad de la capa?)
