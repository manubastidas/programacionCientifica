...
> ⚙️ **Enunciado personalizado — ID 2956.** Los parámetros son únicos. 
...
2. Carpeta con los **apellidos** en la raíz del repositorio:
   ...
   ├── enunciado_2956.md   # el enunciado personalizado
   └── datos_2956.npz      # los datos
   ```
...
(**Comentario**: No muestra directamente la curva reconstruida. Entrena con Adam en vez de descenso de gradiente simple. No me queda claro si entrena una red por régimen o una sola red.)
...
(**Comentario**: Curva de pérdida en semilog-y, no loglog completo. No tiene sentido reportar error a las 40 iteraciones si luego sube nuevamente.)
...
Nota: Hay exceso de IA se nota mucho en los comentarios, demasiado genérico.
